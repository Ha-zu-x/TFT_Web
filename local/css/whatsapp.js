function CreateWhatsappChatWidget(option = {
    ...
    function initWidget(){
        ...
        jQuery('#whatsapp-btn').append(`<div id="whatsapp_chat_widget">
        ...
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box'>
                ...
                <div class='wa-chat-box-send'>
                    ...
                    <!--<div class='wa-chat-box-poweredby'>Powered by <a href="https://wati.io/?utm_source=shopify&utm_medium=chat_widget&utm_campaign=shopify_widget" target="_blank" style="color: #006eff6e;">wati.io</a></div>-->
                </div>
            </div>
        `);
