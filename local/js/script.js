...
(function($) {
    ...
    var LgProdGal = $('.gallery_sp');
    var SmProdGal = $('.sm-gallery');
    LgProdGal.owlCarousel({
        loop: true,
        autoplay: false,
        //autoplayTimeout: 2000,
        autoplayHoverPause: true,
...
$(window).load(function() {
    ...
    // Get product view box
    var MainViewHeight = $('.gallery_sp .mg-gallery-item:not(.video)').height();
    var SmViewHeight = $('.sm-gallery .mg-gallery-item').height();
    var MainProdVideo = $('.gallery_sp .mg-gallery-item.video');
    var SmProdVideo = $('.sm-gallery .mg-gallery-item.video');
    MainProdVideo.each(function() {
        $(this).height(MainViewHeight);
    });
    SmProdVideo.each(function() {
        $(this).height(SmViewHeight);
        $(this).click(function() {

        })
    });
    var SmGalItem = $('.sm-gallery .mg-gallery-item');
    var LgProdGal = $('.gallery_sp');

    SmGalItem.hover(function() {
        var ItemOrder = $(this).attr('data-item');
        LgProdGal.trigger('to.owl.carousel', [ItemOrder]);
    });

    SmGalItem.click(function() {
        var ItemOrder = $(this).attr('data-item');
        LgProdGal.trigger('to.owl.carousel', [ItemOrder]);
        var LgProdGalItem = $(`.gallery_sp .owl-item.active:not(.cloned) [data-item = ${ItemOrder}] a`);
        LgProdGalItem.click();
    })
});