...
function labnolIframe(div) {
    ...
    document.querySelector('.iframe').style.cssText = "position: absolute;top: 0;left: 0;width: 100%;height: 100%;z-index: 100;background: transparent;";
    $('.iframe').css("position: absolute; top: 0; left: 0; ");
}


function initContents() {
    // For Blog post videos embedded
    ...
    for (let i = 0; i < playerElements.length; i++) {
        ...
        $('.youtube-player .play').css("height: 72px;  width: 72px; left: 50%; top: 50%; margin-left: -36px;  margin-top: -36px;  position: absolute; background-image: url('/user-upload/imgs/play-button.png'); background-repeat: no-repeat; cursor: pointer;");
    ...
    // Load style for video player elements
    slideLoad();
    //For blog post
